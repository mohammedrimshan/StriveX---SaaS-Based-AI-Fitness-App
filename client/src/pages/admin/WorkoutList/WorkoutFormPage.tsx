...
const WorkoutFormPage = () => {
  ...
  const validateField = async (name: string, value: any) => {
    try {
      ...
      await Yup.reach(workoutSchemaUpdate, name).validate(value)
  ...
  const handleCropComplete = async (croppedFile: File) => {
    ...
    try {
      const imageUrl = await uploadToCloudinary(croppedFile, "workouts", "image")
  ...
  return (
    <AnimatedBackground>
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <Button variant="ghost" size="sm" asChild className="mr-4 hover:bg-purple-50 hover:text-purple-700 transition-all duration-300">
                ...
                <div className="md:col-span-3 p-8">
                  ...
                  >
                    <div className="space-y-2">
                      <Label htmlFor="title" className="text-base font-medium text-gray-700 flex items-center">
                        Title
                      ...
                      <Input
                        ...
                        className={`border-purple-100 focus:border-purple-300 focus:ring-purple-200 transition-all duration-300 ${
                          touched.title && errors.title ? "border-red-300 focus:ring-red-200" : ""
                        }`}
                      />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="description" className="text-base font-medium text-gray-700 flex items-center">
                        Description
                      ...
                      <Textarea
                        ...
                        required
                        className={`border-purple-100 focus:border-purple-300 focus:ring-purple-200 transition-all duration-300 ${
                          touched.description && errors.description ? "border-red-300 focus:ring-red-200" : ""
                        }`}
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="duration" className="text-base font-medium text-gray-700 flex items-center">
                          Duration (minutes)
                        ...
                        <Input
                          ...
                          required
                          className={`border-purple-100 focus:border-purple-300 focus:ring-purple-200 transition-all duration-300 ${
                            touched.duration && errors.duration ? "border-red-300 focus:ring-red-200" : ""
                          }`}
                        />
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="difficulty" className="text-base font-medium text-gray-700 flex items-center">
                          Difficulty
                        ...
                        >
                          <SelectTrigger className={`border-purple-100 focus:ring-purple-200 transition-all duration-300 ${
                            touched.difficulty && errors.difficulty ? "border-red-300 focus:ring-red-200" : ""
                          }`}>
                    ...
                    <div className="space-y-4 p-6 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 shadow-sm border border-purple-100/50">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Label htmlFor="isPremium" className="text-base font-medium text-gray-700">Premium Workout</Label>
                          <Info className="h-4 w-4 text-purple-400 cursor-help" title="Premium workouts are only available to subscribers" />
                        </div>
                        <Switch
                          id="isPremium"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <Label htmlFor="status" className="text-base font-medium text-gray-700">Active</Label>
                          <Info className="h-4 w-4 text-purple-400 cursor-help" title="Inactive workouts won't be visible to users" />
                        </div>
                        <Switch
                          id="status"
                    ...
                    <div className="flex-1 flex flex-col p-8 relative">
                      ...
                      <div className="flex-1 flex items-center justify-center">
                        <motion.div 
                          ...
                          whileHover={{ boxShadow: "0 20px 25px -5px rgba(168, 85, 247, 0.3)" }}
                          ...
                          {isUploading ? (
                            <div className="w-full h-full flex items-center justify-center bg-gradient-to-r from-purple-50 to-indigo-50">
                              <div className="flex flex-col items-center">
                                ...
                                <p className="text-sm text-purple-600">Uploading to cloud storage...</p>
                              </div>
                            </div>
                          ) : formData.imageUrl ? (
                            ...
                            >
                              <div className="text-center p-6 bg-white/60 rounded-xl backdrop-blur-sm shadow-lg border border-purple-100">
                                ...
                                <h4 className="font-medium text-purple-700 mb-2">Upload Workout Image</h4>
                                <p className="text-sm text-purple-500">Click to select an image file</p>
                                <p className="text-xs text-purple-400 mt-2">
                                  Recommended: 16:9 ratio<br />Maximum size: 10MB
                                </p>
                              </div>
                            </div>
                          )}
