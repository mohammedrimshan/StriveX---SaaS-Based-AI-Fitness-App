...
const playlistMap: Record<string, string> = {
  ...
  // Default playlist for unknown categories
  All: "https://open.spotify.com/embed/playlist/37i9dQZF1DX76Wlfdnj7AP?utm_source=generator&theme=0",
};

interface MusicPlayerProps {
  category: string; // Category from the backend
}

const MusicPlayer: React.FC<MusicPlayerProps> = ({ category }) => {
  ...
  return (
    <motion.div
      className="bg-purple-600 rounded-2xl overflow-hidden shadow-lg"
