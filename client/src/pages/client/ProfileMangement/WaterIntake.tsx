  ...
  return (
    ...
    >
      <div className="flex items-end justify-between">
        <motion.div initial={{ scale: 1 }} animate={{ scale: [1, 1.05, 1], transition: { duration: 0.3 } }} key={value}>
        ...
        <div className="flex items-center text-sm text-muted-foreground">
          <span className="mr-2">Target: 8L</span>
      ...
      <Slider value={[value]} min={0} max={maxWater} step={100} onValueChange={handleSliderChange} className="py-4" />
    </motion.div>
  )
}
