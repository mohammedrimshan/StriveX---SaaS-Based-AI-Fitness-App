    ...
    return (
      <AnimatedBackground>
        <div className="container mx-auto px-2 sm:px-4 py-8 sm:py-12 text-center">
          <AnimatedTitle
            title="Error"
            subtitle="Failed to load client requests"
          />
                ...
                <table className="w-full table-fixed">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      ...
                      <th
                        className="w-1/6 px-2 sm:px-4 py-2 sm:py-3 text-left text-xs fontHAND-medium text-gray-500 uppercase tracking-wider cursor-pointer"
