...
export default function EnhancedPasswordForm() {
  ...
  const { mutate: updatePassword, isPending: isSubmitting } = useTrainerPasswordUpdateMutation()
      ...
      <div className="mx-auto max-w-4xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            ...
            >
              Protect your information by updating your password regularly. Strong passwords help keep your account secure.
            </motion.p>
            ...
            >
              <Alert className="bg-indigo-50 border-indigo-200 text-indigo-800">
                ...
                <AlertDescription className="text-sm">
                  A strong password should include uppercase and lowercase letters, numbers, and special characters. Aim for at least 12 characters.
                </AlertDescription>
              </Alert>
            </motion.div>
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    >
                      <FormField
                        ...
                        render={({ field, fieldState }) => (
                          <FormItem>
                            <FormLabel className="text-indigo-800 text-lg">Current Password</FormLabel>
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input
                                  ...
                                  {...field}
                                  className={`pl-10 py-6 text-base ${fieldState.error ? 'border-red-500 focus-visible:ring-red-500' : 'border-indigo-200 focus-visible:ring-indigo-500'}`}
                                />
                                <Button
                                  type="button"
                                  variant="ghost"
                    ...
                    >
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-indigo-800 text-lg">New Password</FormLabel>
                            <FormControl>
                              <div className="relative">
                              ...
                              {field.value && (
                                ...
                                >
                                  <div className="flex items-center justify-between text-sm mb-1">
                                    ...
                                    >
                                      <span className="flex items-center gap-1">
                                        ...
                                        <span className="text-xl">{emojiMap[strengthText as keyof typeof emojiMap]}</span>
                                      </span>
                                    </motion.span>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-4 gap-2 mt-3">
                                    <motion.div 
                                      className={`flex items-center text-sm gap-1 p-2 rounded-md ${/[A-Z]/.test(field.value) ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"}`}
                                      initial={{ opacity: 0, y: 5 }}
                                      animate={{ opacity: 1, y: 0 }}
                                      transition={{ delay: 0.2 }}
                                    >
                                      <CheckCircle2
                                        className={`h-4 w-4 ${/[A-Z]/.test(field.value) ? "text-green-500" : "text-gray-400"}`}
                                      />
                                      <span>Uppercase</span>
                                    </motion.div>
                                    <motion.div 
                                    ...
                                    <motion.div 
                                      className={`flex items-center text-sm gap-1 p-2 rounded-md ${/[0-9]/.test(field.value) ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"}`}
                                      initial={{ opacity: 0, y: 5 }}
                                      animate={{ opacity: 1, y: 0 }}
                                      transition={{ delay: 0.4 }}
                                    >
                                      <CheckCircle2
                                        className={`h-4 w-4 ${/[0-9]/.test(field.value) ? "text-green-500" : "text-gray-400"}`}
                                      />
                                      <span>Numbers</span>
                                    </motion.div>
                                    <motion.div 
                                      className={`flex items-center text-sm gap-1 p-2 rounded-md ${/[^A-Za-z0-9]/.test(field.value) ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"}`}
                                      initial={{ opacity: 0, y: 5 }}
                                      animate={{ opacity: 1, y: 0 }}
                                      transition={{ delay: 0.5 }}
                                    >
                                      <CheckCircle2
                                        className={`h-4 w-4 ${/[^A-Za-z0-9]/.test(field.value) ? "text-green-500" : "text-gray-400"}`}
                                      />
                                      <span>Special</span>
                                    </motion.div>
                                  </div>
                    ...
                    >
                      <FormField
                        ...
                        render={({ field, fieldState }) => (
                          <FormItem>
                            <FormLabel className="text-indigo-800 text-lg">Confirm New Password</FormLabel>
                            <FormControl>
                              <div className="relative">
                                <Lock className="absolute left-3 top-3 h-5 w-5 text-gray-400" />
                                <Input
