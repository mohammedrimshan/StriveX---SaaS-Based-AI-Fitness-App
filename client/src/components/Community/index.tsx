// D:\StriveX\client\src\components\community\Community.tsx
"use client"
...
useEffect(() => {
  ...
  useEffect(() => {
    if (!socket) {
      console.warn("[DEBUG] Socket not initialized yet")
      return
    }
  ...
  const handleLikePost = async (postId: string) => {
    ...
    try {
      ...
      await likePost({ id: postId, role: currentUser.role, userId: currentUser.id })
